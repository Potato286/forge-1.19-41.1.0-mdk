...
public class FloatyBlock extends Block {
    public FloatyBlock(Properties properties) {
        super(properties);
    }
    ...
    public void stepOn(Level level, BlockPos pos, BlockState state, Entity entity) {
        if(entity instanceof LivingEntity livingEntity){
            livingEntity.addEffect(new MobEffectInstance(MobEffects.LEVITATION, 200, 10));
        }
