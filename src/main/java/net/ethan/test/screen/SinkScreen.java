package net.ethan.test.screen;


import com.mojang.blaze3d.systems.RenderSystem;
import com.mojang.blaze3d.vertex.PoseStack;
import net.ethan.test.Test;
import net.ethan.test.screen.renderer.EnergyInfoArea;
import net.ethan.test.screen.renderer.FluidTankRenderer;
import net.ethan.test.screen.renderer.InfoArea;
import net.ethan.test.util.MouseUtil;
...
public class SinkScreen extends AbstractContainerScreen<SinkMenu> {
    ...
    public SinkScreen(SinkMenu menu, Inventory inventory, Component component) {
